...
# --- Greenhouse / plant defaults ---
DEFAULT_GREENHOUSE_ID     = 1
DEFAULT_NUM_GREENHOUSES   = 1   # simulator: how many greenhouses to simulate
DEFAULT_PLANT_ID          = 1
DEFAULT_NUM_PLANTS        = 3   # simulator: plants per greenhouse
DEFAULT_PUBLISH_INTERVAL  = 5   # seconds

# --- Raspberry Pi hardware pin / bus defaults ---
DHT22_GPIO_PIN     = 17
ADS1115_I2C_ADDR   = 0x48
ADS1115_CHANNEL    = 0      # one soil moisture sensor per RPi
